...
""",
     ...
     ('share/webcleaner/config/blacklists/audio-video',
      ['config/blacklists/audio-video/urls.gz',
       'config/blacklists/audio-video/domains.gz']),
     ('share/webcleaner/config/blacklists/drugs',
      ['config/blacklists/drugs/urls.gz',
       'config/blacklists/drugs/domains.gz']),
     ('share/webcleaner/config/blacklists/gambling',
      ['config/blacklists/gambling/urls.gz',
       'config/blacklists/gambling/domains.gz']),
     ('share/webcleaner/config/blacklists/hacking',
      ['config/blacklists/hacking/urls.gz',
       'config/blacklists/hacking/domains.gz']),
     ('share/webcleaner/config/blacklists/mail',
      ['config/blacklists/mail/domains.gz']),
     ('share/webcleaner/config/blacklists/porn',
      ['config/blacklists/porn/urls.gz',
       'config/blacklists/porn/domains.gz']),
     ('share/webcleaner/config/blacklists/proxy',
      ['config/blacklists/proxy/urls.gz',
       'config/blacklists/proxy/domains.gz']),
     ('share/webcleaner/config/blacklists/violence',
      ['config/blacklists/violence/urls.gz',
       'config/blacklists/violence/domains.gz']),
     ('share/webcleaner/config/blacklists/warez',
      ['config/blacklists/warez/urls.gz',
       'config/blacklists/warez/domains.gz']),
     ('man/man1',
      ['webcleaner.1',
       'webcleanerconf.1',
       'wcheaders.1',
