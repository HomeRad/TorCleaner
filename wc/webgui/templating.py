...
class Templates:
    ...
    def get (self, name, extension):
        ...
        self.templates[filename] = pt = WcPageTemplate()
...
class WcPageTemplate (PageTemplate.PageTemplate):
    ''' A WebCleaner-specific PageTemplate.
        ...
        *context*
         ...
         1. None - we're viewing a "static" page
         2. The current class of item being displayed.
        *request*
...
function help_window(helpurl, width, height) {
    HelpWin = window.open('%s' + helpurl, 'WcHelpWindow', 'scrollbars=yes,resizable=yes,toolbar=no,height='+height+',width='+width);
}
</script>
'''%self.base
