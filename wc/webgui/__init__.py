...
def get_context (dirs, form, localcontext):
    ...
    add_default_context(context, form, template)
    # augment the context
...
def add_default_context (context, form, template):
    # form values
    ...
    context.addGlobal("footer", i18n._("Generated by")+" "+App)
    # language
    context.addGlobal("lang", i18n.get_language())
