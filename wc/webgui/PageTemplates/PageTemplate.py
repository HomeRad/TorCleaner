...
Calvin:
- changed imports to import from wc.webgui
...
from wc.webgui.TAL.XMLTALCompiler import XMLTALCompiler
from wc.webgui.TAL.HTMLTALCompiler import HTMLTALCompiler
...
class PageTemplate:
    ...
    def _cook(self):
        ...
        if self.html():
            ...
            parser = HTMLTALCompiler(gen)
        else:
            gen = TALGenerator(getEngine(), source_file=source_file)
            parser = XMLTALCompiler(gen)
