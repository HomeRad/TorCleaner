...
class TestUrl (unittest.TestCase):
    ...
    def test_pathattack (self):
        ...
        self.assertEquals(wc.net.url.url_quote(wc.net.url.url_norm(url)), nurl)
    ...
    def test_quoting (self):
        ...
        nurl = url
        self.assertEqual(wc.net.url.url_quote(wc.net.url.url_norm(url)), nurl)

    def test_fixing (self):
        url = r"http://groups.google.com\test.html"
        nurl = "http://groups.google.com/test.html"
        self.assertEqual(wc.net.url.url_norm(url), nurl)
    ...
    def test_valid (self):
        self.assert_(wc.net.url.is_valid_url("http://www.imadoofus.com"))
        self.assert_(wc.net.url.is_valid_url("http://www.imadoofus.com/"))
        self.assert_(wc.net.url.is_valid_url("http://www.imadoofus.com/~calvin"))
        self.assert_(wc.net.url.is_valid_url("http://www.imadoofus.com/a,b"))
        self.assert_(wc.net.url.is_valid_url("http://www.imadoofus.com#anchor55"))
        self.assert_(wc.net.url.is_valid_js_url("http://www.imadoofus.com/?hulla=do"))
