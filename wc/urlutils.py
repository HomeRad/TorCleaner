...
##  SOFTWARE.
#
# Version 2.9; see changelog for revision history

import httplib, urllib, urllib2, getpass, re
try:
    import webbrowser
except:
    webbrowser = None
from wc import Version
UA_STR = 'WebCleaner/'+ Version
