...
<folder sid="wc.323" oid="2" title="HTTP Headers"
 desc="Add, delete and modify HTTP headers.">

<header sid="wc.313" oid="0" title="My own user-agent"
...
<header sid="wc.314" oid="1" title="No referer"
...
<header sid="wc.321" oid="8" title="No UA-*"
...
<header sid="wc.322" oid="9" title="No Cookies"
