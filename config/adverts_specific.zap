...
<rewrite sid="wc.399" tag="heiseadvert">
...
<rewrite sid="wc.400" tag="contentbanner">
...
<rewrite sid="wc.12" tag="skyscraper">
<title lang="en">Heise skyscraper</title>
<matchurl>^http://(www\.)heise\.de/</matchurl>
</rewrite>


<rewrite sid="wc.11" tag="table">
