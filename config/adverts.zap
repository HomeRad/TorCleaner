...
<rewrite sid="wc.345" oid="12" title="Adverts in the path name 02"
 desc="Kill links with ad words in the path name.">
<attr>/(v?banner(s|_redirect|click)|clickit|werbung|RealMedia|phpAdsNew|adclick)/</attr>
<replacement part="complete"/>
</rewrite>

<rewrite sid="wc.346" oid="13" title="Adverts in the path name 03"
 desc="Kill links with ad words in the path name.">
<attr>/event\.ng(\?|/)Type=click</attr>
<replacement part="complete"/>
</rewrite>

<rewrite sid="wc.347" oid="14" title="Adverts in the path name 04"
 desc="Kill links with ad words in the path name.">
<attr>\.eu-adcenter\.net</attr>
<replacement part="complete"/>
</rewrite>

<rewrite sid="wc.348" oid="15" title="Adverts in the path name 7">
