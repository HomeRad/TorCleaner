...
<htmlrewrite sid="wc.334"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">https?://([^/])*\.ad(force|runner|se?rve?|stream|\d*|view|s|log|vert(s|enties|is(ing|e?ments)?)?)\.</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.344"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">/(web)?ad(force|runner|se?rve?|stream|\d*|s|view|log|vert(s|enties|is(ing|e?ments)?)?)/</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.402"
 tag="a|iframe|script">
  ...
  <description lang="en">Kill links with ad words in the path name.</description>
  <attr name="^href|src$">/adbouncer\.phtml</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.403"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">easy-cash</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.336"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">https?://(servedby\.)?ad(s|server(\d+)?|vertising)?\.</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.335"
 tag="a|iframe|script">
  ...
  <description lang="en">Kill links with ad words in the host name.</description>
  <attr name="^href|src$">https?://[^/]*(tradedoubler|emerchandise|ecommercetimes|ivwbox)\.</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.337"
 tag="a|iframe|script">
  ...
  <description lang="en">Kill links with ad words in the host name.</description>
  <attr name="^href|src$">https?://[^/]*((link|media)exchange|mediaplex|realmedia|imgis|adsynergy|fast(click|counter|graphics)|hitexchange)\.</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.343"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">/adclick\.(exe|php)</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.345"
 tag="a|iframe|script">
  ...
  <description lang="en">Kill links with ad words in the path name.</description>
  <attr name="^href|src$">/(v?banner(s|_redirect|click)|clickit|werbung|RealMedia|phpAdsNew|adclick)/</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.346"
 tag="a|iframe|script">
  ...
  <description lang="en">Kill links with ad words in the path name.</description>
  <attr name="^href|src$">/event\.ng(\?|/)Type=click</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.347"
 tag="a|iframe|script">
  ...
  <description lang="en">Kill links with ad words in the path name.</description>
  <attr name="^href|src$">\.eu-adcenter\.net</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.348"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">([\.\?]click\?|click(stream|thrutraffic|thru|xchange)|clickId=|smartserve/click)</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.355"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">/(publicite|werbung|rekla(ma|me|am)|annonse|maino(kset|nta|s)?)/</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.338"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">https?://((eur\.)?rd\.yahoo\.com|ar\.atwola\.com|partners\.webmasterplan\.com|www\.qksrv\.net|s0b\.bluestreak\.com|ar\.atwola\.com|pagead\.google\.com)</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.342"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">(a\.tribalfusion\.com|ads\.adcode\.de|www\.bethedealer\.com)</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.359"
 tag="a|iframe|script">
  ...
  <description lang="en">Kill links with ad words in the host name.</description>
  <attr name="^href|src$">(adlink|microexchange|sponsornetz|spezialreporte|emedia|bannercommunity)\.de</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.341"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">https?://[^/]*(fastclick|doubleclick|click(it|finders|burst|here\.egroups))\.</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.350"
 tag="a|iframe|script">
  ...
  <attr name="^href|src$">/cgi-bin/ads?(log(\.pl)?|click)?\?</attr>
</htmlrewrite>
...
<htmlrewrite sid="wc.352"
 tag="a|iframe|script">
  ...
  <description lang="en">Matches imagess served by CGI and with advert words in the path.</description>
  <attr name="^href|src$">clickthru.(acc|aspx)\?</attr>
</htmlrewrite>
