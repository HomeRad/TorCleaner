...
<folder sid="wc.392" title="Blacklist aggressive"
 desc="Automatically generated" oid="8">
<blockdomains sid="wc.390" title="aggressive domain filter"
 desc="You should not edit this filter, only disable or delete it." filename="blacklists/aggressive/domains.gz"/>

<blockurls sid="wc.391" title="aggressive url filter"
